...
limits1 = [103, 161, 296, 161]
limits2 = [527, 489, 735, 489]
count1 = []
count2 = []
...
while True:
    ...
    cv2.putText(img, str(len(count1)), (949, 345), cv2.FONT_HERSHEY_PLAIN, 5, (139, 195, 75), 5)
    cv2.putText(img, str(len(count2)), (1191, 345), cv2.FONT_HERSHEY_PLAIN, 5, (50, 50, 230), 5)
